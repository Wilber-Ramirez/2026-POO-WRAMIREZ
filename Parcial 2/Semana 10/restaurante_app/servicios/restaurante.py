...
class Restaurante:
    ...
    def cargar_productos(self, productos: List[Producto]) -> None:
        """Carga una lista de productos en el servicio."""
    ...
    def obtener_productos_dict(self) -> List[dict]:
        """Retorna los productos como lista de diccionarios para serialización."""
        return [p.a_diccionario() for p in self._productos]
